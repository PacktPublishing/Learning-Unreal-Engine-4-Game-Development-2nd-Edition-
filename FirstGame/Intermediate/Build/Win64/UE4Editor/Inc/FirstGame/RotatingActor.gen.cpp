...
// Cross Module References
	...
	FIRSTGAME_API UFunction* Z_Construct_UFunction_ARotatingActor_SetRotationRate();
...
// End Cross Module References
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ARotatingActor_SetRotationRate_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ARotatingActor, nullptr, "SetRotationRate", nullptr, nullptr, sizeof(RotatingActor_eventSetRotationRate_Parms), Z_Construct_UFunction_ARotatingActor_SetRotationRate_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ARotatingActor_SetRotationRate_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ARotatingActor_SetRotationRate_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ARotatingActor_SetRotationRate_Statics::Function_MetaDataParams)) };
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ARotatingActor_Statics::NewProp_bRotate = { "bRotate", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ARotatingActor), &Z_Construct_UClass_ARotatingActor_Statics::NewProp_bRotate_SetBit, METADATA_PARAMS(Z_Construct_UClass_ARotatingActor_Statics::NewProp_bRotate_MetaData, ARRAY_COUNT(Z_Construct_UClass_ARotatingActor_Statics::NewProp_bRotate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ARotatingActor_Statics::NewProp_Mesh = { "Mesh", nullptr, (EPropertyFlags)0x00100000000a000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARotatingActor, Mesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ARotatingActor_Statics::NewProp_Mesh_MetaData, ARRAY_COUNT(Z_Construct_UClass_ARotatingActor_Statics::NewProp_Mesh_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ARotatingActor_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_ARotatingActor_Statics::PropPointers),
		0,
		0x009000A0u,
