...
// Cross Module References
	...
	FIRSTGAME_API UFunction* Z_Construct_UFunction_AFirstActor_CheckLifetime();
	FIRSTGAME_API UFunction* Z_Construct_UFunction_AFirstActor_PrintLevel();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFirstActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFirstActor_CheckLifetime, "CheckLifetime" }, // 2319129305
		{ &Z_Construct_UFunction_AFirstActor_PrintLevel, "PrintLevel" }, // 426405495
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFirstActor_Statics::NewProp_FirstActorMesh = { "FirstActorMesh", nullptr, (EPropertyFlags)0x00100000000a0009, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFirstActor, FirstActorMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AFirstActor_Statics::NewProp_FirstActorMesh_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFirstActor_Statics::NewProp_FirstActorMesh_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AFirstActor_Statics::NewProp_ActorLevel = { "ActorLevel", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFirstActor, ActorLevel), METADATA_PARAMS(Z_Construct_UClass_AFirstActor_Statics::NewProp_ActorLevel_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFirstActor_Statics::NewProp_ActorLevel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFirstActor_Statics::NewProp_ActorLifetime = { "ActorLifetime", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFirstActor, ActorLifetime), METADATA_PARAMS(Z_Construct_UClass_AFirstActor_Statics::NewProp_ActorLifetime_MetaData, ARRAY_COUNT(Z_Construct_UClass_AFirstActor_Statics::NewProp_ActorLifetime_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AFirstActor_Statics::ClassParams = {
		...
		ARRAY_COUNT(Z_Construct_UClass_AFirstActor_Statics::PropPointers),
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_AFirstActor_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_AFirstActor_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AFirstActor, 2375958129);
